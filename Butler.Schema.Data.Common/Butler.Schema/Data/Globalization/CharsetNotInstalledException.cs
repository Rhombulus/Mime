...
namespace Butler.Schema.Data.Globalization
{
  ...
  public class CharsetNotInstalledException : InvalidCharsetException
  {
    public CharsetNotInstalledException(int codePage)
      : base(codePage, CtsResources.GlobalizationStrings.NotInstalledCodePage(codePage))
    {
    }

    public CharsetNotInstalledException(string charsetName)
      : base(charsetName, CtsResources.GlobalizationStrings.NotInstalledCharset(charsetName == null ? "<null>" : charsetName))
    {
    }

    internal CharsetNotInstalledException(string charsetName, int codePage)
      : base(charsetName, codePage, CtsResources.GlobalizationStrings.NotInstalledCharsetCodePage(codePage, charsetName == null ? "<null>" : charsetName))
    {
    }
