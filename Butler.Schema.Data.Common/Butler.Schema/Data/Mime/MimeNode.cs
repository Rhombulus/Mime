    ...
    public abstract class MimeNode : IEnumerable<MimeNode> {
        ...
        public MimeNode InsertBefore(MimeNode newChild, MimeNode refChild) {
            ...
            if (refChild == null)
                ...
                if (refChild == null)
                    throw new ArgumentException(CtsResources.Strings.RefChildIsNotMyChild, nameof(refChild));
            }
        ...
        public MimeNode ReplaceChild(MimeNode newChild, MimeNode oldChild) {
            ...
            if (this != oldChild.Parent)
                throw new ArgumentException(CtsResources.Strings.OldChildIsNotMyChild, nameof(oldChild));
        ...
        public virtual MimeNode Clone() {
            throw new NotSupportedException(
                CtsResources.Strings.ThisNodeDoesNotSupportCloning(
                    this.GetType()
                        .ToString()));
        }
        ...
        internal MimeNode InternalInsertAfter(MimeNode newChild, MimeNode refChild) {
            ...
            if (newChild.Parent != null)
                throw new ArgumentException(CtsResources.Strings.NewChildCannotHaveDifferentParent);
        ...
        public struct Enumerator<T> : IEnumerator<T>, IDisposable, System.Collections.IEnumerator where T : MimeNode {
            ...
            object System.Collections.IEnumerator.Current {
                get {
                    if (current == null)
                        throw new InvalidOperationException((object) next == null ? CtsResources.Strings.ErrorAfterLast : CtsResources.Strings.ErrorBeforeFirst);
                    return current;
                }
            }
