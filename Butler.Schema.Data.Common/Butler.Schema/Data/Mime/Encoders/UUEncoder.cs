        ...
        public string FileName {
            ...
            set {
                ...
                if (value != null)
                    num = value.Length;
                if (num > 48)
                    throw new ArgumentOutOfRangeException("FileName", CtsResources.EncodersStrings.UUEncoderFileNameTooLong(48));
                if (num == 0)
                    fileName = null;
                else
                    fileName = CTSGlobals.AsciiEncoding.GetBytes(value);
            }
        }
