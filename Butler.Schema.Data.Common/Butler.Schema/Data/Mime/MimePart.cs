...
namespace Butler.Schema.Data.Mime {
    ...
    public partial class MimePart : MimeNode, IDisposable, IEnumerable<MimePart> {
        ...
        public System.IO.Stream GetRawContentWriteStream() {
            ...
            using (ThreadAccessGuard.EnterPublic(accessToken)) {
                if (this.IsMultipart)
                    throw new NotSupportedException(CtsResources.Strings.ModifyingRawContentOfMultipartNotSupported);
        ...
        public void SetContentStream(ContentTransferEncoding transferEncoding, System.IO.Stream contentStream, CachingMode cachingMode) {
            ...
            using (ThreadAccessGuard.EnterPublic(accessToken)) {
                ...
                if (!contentStream.CanRead)
                    throw new ArgumentException(CtsResources.Strings.StreamMustSupportRead, nameof(contentStream));
                if (this.IsMultipart)
                    throw new NotSupportedException(CtsResources.Strings.ModifyingRawContentOfMultipartNotSupported);
                var dataStart = 0L;
        ...
        internal override MimeNode ValidateNewChild(MimeNode newChild, MimeNode refChild) {
            ...
            using (ThreadAccessGuard.EnterPublic(accessToken)) {
                ...
                if (mimePart == null)
                    throw new ArgumentException(CtsResources.Strings.NewChildIsNotAPart);
                ...
                throw new ArgumentException(CtsResources.Strings.ThisPartBelongsToSubtreeOfNewChild);
            }
        }
