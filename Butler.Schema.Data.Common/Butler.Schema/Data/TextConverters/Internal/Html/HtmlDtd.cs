...
// Type: Microsoft.Exchange.Data.TextConverters.Internal.Html.HtmlDtd
...
namespace Butler.Schema.Data.TextConverters.Internal.Html
{
  ...
  {
    public static HtmlDtd.TagDefinition[] tags = new HtmlDtd.TagDefinition[122]
    {
    ...
    public static byte[] sets = unchecked(new byte[848]
    {
      (byte) 0,
      (byte) 0,
      (byte) 0,
    ...
    {
      return 0 != ((int) HtmlDtd.sets[(int) (set + (short) ((int) tag >> 3))] & (int) (byte) (1U << (int) (tag & HtmlTagIndex.Unknown & HtmlTagIndex.Comment)));
    }
