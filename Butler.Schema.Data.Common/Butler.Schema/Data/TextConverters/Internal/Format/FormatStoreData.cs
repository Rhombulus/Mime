...
// Type: Microsoft.Exchange.Data.TextConverters.Internal.Format.FormatStoreData
...
namespace Butler.Schema.Data.TextConverters.Internal.Format
{
  ...
  {
    internal static FormatStore.StringValueEntry[] GlobalStringValues = new FormatStore.StringValueEntry[2]
    {
      new FormatStore.StringValueEntry(),
      new FormatStore.StringValueEntry("Courier New")
    };
    internal static FormatStore.MultiValueEntry[] GlobalMultiValues = new FormatStore.MultiValueEntry[1]
    {
      new FormatStore.MultiValueEntry()
    };
    internal static FormatStore.StyleEntry[] GlobalStyles = new FormatStore.StyleEntry[26]
    {
      new FormatStore.StyleEntry(),
      new FormatStore.StyleEntry(new FlagProperties(3U), new PropertyBitMask(0U, 0U), (Property[]) null),
      new FormatStore.StyleEntry(new FlagProperties(3U), new PropertyBitMask(2U, 0U), new Property[1]
      {
        new Property(PropertyId.FontSize, new PropertyValue(PropertyType.RelHtmlFontUnits, 1))
      }),
      new FormatStore.StyleEntry(new FlagProperties(3072U), new PropertyBitMask(0U, 0U), (Property[]) null),
      new FormatStore.StyleEntry(new FlagProperties(12U), new PropertyBitMask(0U, 0U), (Property[]) null),
      new FormatStore.StyleEntry(new FlagProperties(48U), new PropertyBitMask(0U, 0U), (Property[]) null),
      new FormatStore.StyleEntry(new FlagProperties(2U), new PropertyBitMask(2U, 0U), new Property[1]
      {
        new Property(PropertyId.FontSize, new PropertyValue(PropertyType.RelHtmlFontUnits, -1))
      }),
      new FormatStore.StyleEntry(new FlagProperties(192U), new PropertyBitMask(2U, 0U), new Property[1]
      {
        new Property(PropertyId.FontSize, new PropertyValue(PropertyType.RelHtmlFontUnits, -1))
      }),
      new FormatStore.StyleEntry(new FlagProperties(768U), new PropertyBitMask(2U, 0U), new Property[1]
      {
        new Property(PropertyId.FontSize, new PropertyValue(PropertyType.RelHtmlFontUnits, -1))
      }),
      new FormatStore.StyleEntry(new FlagProperties(0U), new PropertyBitMask(6U, 0U), new Property[2]
      {
        new Property(PropertyId.FontSize, new PropertyValue(PropertyType.RelHtmlFontUnits, -1)),
        new Property(PropertyId.FontFace, new PropertyValue(PropertyType.String, 1))
      }),
      new FormatStore.StyleEntry(new FlagProperties(0U), new PropertyBitMask(4U, 0U), new Property[1]
      {
        new Property(PropertyId.FontFace, new PropertyValue(PropertyType.String, 1))
      }),
      new FormatStore.StyleEntry(new FlagProperties(0U), new PropertyBitMask(512U, 0U), new Property[1]
      {
        new Property(PropertyId.UnicodeBiDi, new PropertyValue(PropertyType.Enum, 2))
      }),
      new FormatStore.StyleEntry(new FlagProperties(3145728U), new PropertyBitMask(0U, 0U), (Property[]) null),
      new FormatStore.StyleEntry(new FlagProperties(0U), new PropertyBitMask(8U, 0U), new Property[1]
      {
        new Property(PropertyId.TextAlignment, new PropertyValue(PropertyType.Enum, 1))
      }),
      new FormatStore.StyleEntry(new FlagProperties(3932160U), new PropertyBitMask(6U, 0U), new Property[2]
      {
        new Property(PropertyId.FontSize, new PropertyValue(PropertyType.RelHtmlFontUnits, -1)),
        new Property(PropertyId.FontFace, new PropertyValue(PropertyType.String, 1))
      }),
      ...
      new FormatStore.StyleEntry(new FlagProperties(0U), new PropertyBitMask(40960U, 0U), new Property[2]
      {
      ...
      new FormatStore.StyleEntry(new FlagProperties(0U), new PropertyBitMask(0U, 6U), new Property[2]
      {
      ...
      new FormatStore.StyleEntry(new FlagProperties(0U), new PropertyBitMask(0U, 2U), new Property[1]
      {
        new Property(PropertyId.ListStyle, new PropertyValue(PropertyType.Enum, 1))
      }),
      new FormatStore.StyleEntry(new FlagProperties(0U), new PropertyBitMask(20480U, 0U), new Property[2]
      {
    ...
    internal static FormatStore.InheritaceMask[] GlobalInheritanceMasks = new FormatStore.InheritaceMask[6]
    {
