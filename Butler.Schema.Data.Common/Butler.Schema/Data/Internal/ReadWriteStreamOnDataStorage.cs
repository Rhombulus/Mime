  ...
  internal class ReadWriteStreamOnDataStorage : StreamOnDataStorage, ICloneableStream
  {
    ...
    public override long Position
    {
      ...
      set
      {
        if (this.storage == null)
          throw new ObjectDisposedException("ReadWriteStreamOnDataStorage");
        if (value < 0L)
          throw new ArgumentOutOfRangeException(nameof(value), CtsResources.SharedStrings.CannotSeekBeforeBeginning);
        this.position = value;
      }
    }
    ...
    public override void SetLength(long value)
    {
      if (this.storage == null)
        throw new ObjectDisposedException("ReadWriteStreamOnDataStorage");
      if (value < 0L)
        throw new ArgumentOutOfRangeException(nameof(value), CtsResources.SharedStrings.CannotSetNegativelength);
    ...
    public override long Seek(long offset, SeekOrigin origin)
    {
      ...
      if (offset < 0L)
        throw new ArgumentOutOfRangeException(nameof(offset), CtsResources.SharedStrings.CannotSeekBeforeBeginning);
      this.position = offset;
      return this.position;
    }
