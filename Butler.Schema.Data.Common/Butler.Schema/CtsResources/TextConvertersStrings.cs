...
// Type: Microsoft.Exchange.CtsResources.TextConvertersStrings
...
namespace Butler.Schema.CtsResources
{
  internal static class TextConvertersStrings
  {
    ...
    {
      return string.Format(TextConvertersStrings.ResourceManager.GetString("CreateFileFailed"), (object) filePath);
    }

    public static string LengthExceeded(int sum, int length)
    {
      return string.Format(TextConvertersStrings.ResourceManager.GetString("LengthExceeded"), (object) sum, (object) length);
    }

    public static string InvalidConfigurationBoolean(int propertyId)
    {
      return string.Format(TextConvertersStrings.ResourceManager.GetString("InvalidConfigurationBoolean"), (object) propertyId);
    }

    public static string InvalidConfigurationInteger(int propertyId)
    {
      return string.Format(TextConvertersStrings.ResourceManager.GetString("InvalidConfigurationInteger"), (object) propertyId);
    }

    public static string CannotWriteOtherTagsInsideElement(string elementName)
    {
      return string.Format(TextConvertersStrings.ResourceManager.GetString("CannotWriteOtherTagsInsideElement"), (object) elementName);
    }

    public static string InvalidConfigurationStream(int propertyId)
    {
      return string.Format(TextConvertersStrings.ResourceManager.GetString("InvalidConfigurationStream"), (object) propertyId);
    }

    public static string DocumentGrowingExcessively(int ratio)
    {
      return string.Format(TextConvertersStrings.ResourceManager.GetString("DocumentGrowingExcessively"), (object) ratio);
    }

    public static string InvalidCodePage(int codePage)
    {
      return string.Format(TextConvertersStrings.ResourceManager.GetString("InvalidCodePage"), (object) codePage);
    }
